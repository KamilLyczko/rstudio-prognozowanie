#funkcja zwracająca wektor opisujący czas obserwacji o podanym numerze
...
#funkcja zwracająca wektor indeksów obserwacji równych 0
...
#funkcja generująca wykres z prognozami z numerami tygodni na osi czasu
...
#funkcja generująca wykres z prognozami z datami na osi czasu
...
#funkcja generująca wykres z wartościami rzeczywistymi 
# i wartościami dopasowanymi na podstawie podanego modelu
...
#funkcja generująca wykres porównania wartości rzeczywistych z prognozami
...
#funkcja generująca wykres czasowy podanego szeregu
...
#funkcje operujące na miernikach błędów predykcji-------------------------------------

#funkcja obliczająca błędy treningowe
