...
plot_title2 <- "Por?wnanie prognoz liczby zakażeń z szeregiem testowym dla II fali"

generate_naive_forecasts_plot(confirmed2.train, c2_naive_forecasts, plot_title1, "liczba zakażeń")
generate_naive_test_comparison_plot(confirmed2.test, c2_naive_forecasts, plot_title2, "liczba zakazeń")
...
plot_title2 <- "Por?wnanie prognoz liczby zakażeń z szeregiem testowym dla III fali"
...
plot_title2 <- "Por?wnanie prognoz liczby zakażeń z szeregiem testowym dla IV fali"
